...
export default function ProductDemo() {
  return (
    <section className="py-20 bg-rhiz-gray-50 flex flex-col items-center" aria-label="Product demo">
      <h2 className="text-3xl md:text-4xl font-semibold text-center mb-6 text-rhiz-dark">See Your Network as a Living Graph</h2>
      ...
      >
        ...
        <div className="w-full h-64 flex items-center justify-center bg-gradient-to-br from-rhiz-teal/10 to-rhiz-purple/10 rounded-xl mb-6">
          <span className="text-rhiz-teal font-semibold text-xl">[Graph Preview Coming Soon]</span>
        </div>
        <a href="/dashboard/network" className="px-8 py-3 rounded-lg bg-rhiz-teal text-white font-semibold shadow-lg hover:bg-rhiz-gold hover:text-rhiz-dark transition">Try the Network Graph</a>
      </motion.div>
    </section>
  );
} 